...
import eu.ebrains.kg.projects.ebrains.source.BrainAtlasV3;
import eu.ebrains.kg.projects.ebrains.target.BrainAtlas;
...
public class BrainAtlasTranslator extends EBRAINSTranslator<BrainAtlasV3, BrainAtlas, BrainAtlasTranslator.Result> {
