...
import eu.ebrains.kg.common.model.target.ValueWithDetails;
...
public class WorkflowRecipeVersionTranslator extends EBRAINSTranslator<WorkflowRecipeVersionV3, WorkflowRecipeVersion, WorkflowRecipeVersionTranslator.Result> {

    public static class Result extends ResultsOfKG<WorkflowRecipeVersionV3> {
    }
