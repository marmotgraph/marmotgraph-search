...
import eu.ebrains.kg.projects.ebrains.source.ControlledTermV3;
import eu.ebrains.kg.projects.ebrains.target.ControlledTerm;
...
public class ControlledTermTranslator extends EBRAINSTranslator<ControlledTermV3, ControlledTerm, ControlledTermTranslator.Result> {
    ...
    private static final String CONTROLLED_TERM_NAMESPACE = "/controlledTerms";
    ...
    public static class Result extends ResultsOfKG<ControlledTermV3> {
    }
