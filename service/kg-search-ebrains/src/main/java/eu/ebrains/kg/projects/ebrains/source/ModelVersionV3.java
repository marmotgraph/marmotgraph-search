...
@Getter
@Setter
public class ModelVersionV3 extends SourceInstance implements IsCiteable, HasMetrics, HasAccessibility, HasMetaBadges {
    ...
    private FileV3 fullDocumentationFile;
