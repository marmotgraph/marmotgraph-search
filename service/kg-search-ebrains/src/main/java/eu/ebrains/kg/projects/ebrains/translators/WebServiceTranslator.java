...
import eu.ebrains.kg.projects.ebrains.source.WebServiceV3;
import eu.ebrains.kg.projects.ebrains.source.commons.Version;
import eu.ebrains.kg.projects.ebrains.target.WebService;
...
public class WebServiceTranslator extends EBRAINSTranslator<WebServiceV3, WebService, WebServiceTranslator.Result> {
    public static class Result extends ResultsOfKG<WebServiceV3> {
    }
    ...
    public WebService translate(WebServiceV3 webservice, DataStage dataStage, boolean liveMode, TranslatorUtils translatorUtils) throws TranslationException {
        ...
        List<Version> sortedVersions = EBRAINSTranslatorUtils.sort(webservice.getVersions(), translatorUtils.getErrors());
