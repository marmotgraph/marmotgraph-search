...
import eu.ebrains.kg.projects.ebrains.source.SoftwareV3;
import eu.ebrains.kg.projects.ebrains.source.commons.Version;
import eu.ebrains.kg.projects.ebrains.target.Software;
...
public class SoftwareTranslator extends EBRAINSTranslator<SoftwareV3, Software, SoftwareTranslator.Result> {
    public static class Result extends ResultsOfKG<SoftwareV3> {
    }
    ...
    public Software translate(SoftwareV3 software, DataStage dataStage, boolean liveMode, TranslatorUtils translatorUtils) throws TranslationException {
        ...
        List<Version> sortedVersions = EBRAINSTranslatorUtils.sort(software.getVersions(), translatorUtils.getErrors());
