...
import eu.ebrains.kg.projects.ebrains.source.FileV3;
import eu.ebrains.kg.projects.ebrains.target.File;
...
public class FileTranslator extends EBRAINSTranslator<FileV3, File, FileTranslator.Result> {
