...
import eu.ebrains.kg.projects.ebrains.source.ParcellationEntityVersionV3;
import eu.ebrains.kg.projects.ebrains.source.commons.Version;
import eu.ebrains.kg.projects.ebrains.source.commons.Versions;
import eu.ebrains.kg.projects.ebrains.target.ParcellationEntityVersion;
...
public class ParcellationEntityVersionTranslator extends EBRAINSTranslator<ParcellationEntityVersionV3, ParcellationEntityVersion, ParcellationEntityVersionTranslator.Result> {

    public static class Result extends ResultsOfKG<ParcellationEntityVersionV3> {
    }
    ...
    public ParcellationEntityVersion translate(ParcellationEntityVersionV3 parcellationEntityVersion, DataStage dataStage, boolean liveMode, TranslatorUtils translatorUtils) throws TranslationException {
        ...
        if (hasMultipleVersions) {
            ...
            pev.setAllVersionRef(new TargetInternalReference(IdUtils.getUUID(parcellationEntity.getId()), "version overview"));
        }
