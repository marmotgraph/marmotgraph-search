...
@MetaInfo(name="LivePaper", searchable=true)
@Getter
@Setter
public class LivePaperVersion implements TargetInstance, VersionedInstance, HasCitation, HasTrendingInformation, HasBadges {
    @JsonIgnore
    private List<String> allIdentifiers;

    @ElasticSearchInfo(type = "keyword")
    private final Value<String> type = new Value<>("LivePaper");
    ...
    @FieldInfo(label = "Custodians", separator = "; ", hint = "A custodian is the person responsible for the live paper.", boost = 10, useForSuggestion = true, overview = true)
