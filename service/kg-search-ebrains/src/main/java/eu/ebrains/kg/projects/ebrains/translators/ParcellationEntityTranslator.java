...
import eu.ebrains.kg.projects.ebrains.source.ParcellationEntityV3;
import eu.ebrains.kg.projects.ebrains.source.commons.Version;
import eu.ebrains.kg.projects.ebrains.target.ParcellationEntity;
...
public class ParcellationEntityTranslator extends EBRAINSTranslator<ParcellationEntityV3, ParcellationEntity, ParcellationEntityTranslator.Result> {

    public static class Result extends ResultsOfKG<ParcellationEntityV3> {
    }
