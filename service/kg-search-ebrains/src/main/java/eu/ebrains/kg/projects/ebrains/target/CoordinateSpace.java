...
@Getter
@Setter
@MetaInfo(name = "CoordinateSpace")
public class CoordinateSpace implements TargetInstance {
    @JsonIgnore
    private List<String> allIdentifiers;

    @ElasticSearchInfo(type = "keyword")
    private final Value<String> type = new Value<>("CoordinateSpace");
    ...
    private Value<String> versionIdentifier;
    ...
    @FieldInfo(label="Anatomical axes orientation")
    private TargetInternalReference anatomicalAxesOritentation;
