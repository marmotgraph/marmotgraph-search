...
@Getter
@Setter
@MetaInfo(name = "Protocol")
public class Protocol implements TargetInstance {
    ...
    @FieldInfo(label = "Stimulus type")
    private List<TargetInternalReference> stimulusType;

    @FieldInfo(fieldType = FieldInfo.FieldType.MARKDOWN, overview = true)
    private Value<String> description;

    @FieldInfo(label = "Datasets using this protocol", layout = "Datasets")
