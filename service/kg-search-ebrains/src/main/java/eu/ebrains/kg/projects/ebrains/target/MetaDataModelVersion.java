...
@Getter
@Setter
@MetaInfo(name = "(Meta)Data Model", searchable=true)
public class MetaDataModelVersion implements TargetInstance, VersionedInstance, HasCitation, HasBadges, HasTrendingInformation {
    ...
    @FieldInfo(layout = "Get (meta)data model", fieldType = FieldInfo.FieldType.FILE_PREVIEW)
    ...
    @FieldInfo(layout = "Get (meta)data model", fieldType = FieldInfo.FieldType.HIERARCHICAL_FILES_ASYNC, labelHidden = true)
