...
import eu.ebrains.kg.projects.ebrains.source.commons.Copyright;
...
import eu.ebrains.kg.projects.ebrains.source.commons.QuantitativeValueOrRange;
...
@Getter
@Setter
public class LearningResourceV3 extends SourceInstance {
    private String name;
    ...
    private List<PersonOrOrganizationRef> publisher;
    private Copyright copyright;
    private List<FullNameRefForResearchProductVersion> about;
    ...
    private List<String> learningResourceType;
    private List<FullNameRef> license;
    private QuantitativeValueOrRange requiredTime;
