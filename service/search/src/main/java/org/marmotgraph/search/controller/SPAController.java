...
public class SPAController {
    ...
    private final Customization indexHtmlExtension;
    private final Resource indexHtml;

    public SPAController(Customization indexHtmlExtension, @Value("classpath:public/index.html") Resource indexHtml) {
