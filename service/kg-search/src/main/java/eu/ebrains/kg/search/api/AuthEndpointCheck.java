...
public class AuthEndpointCheck {
    ...
    public AuthEndpointCheck(KGServiceClient kgServiceClient) {
        this.kgServiceClient = kgServiceClient;
    }

    public boolean checkAuthEndpointIsAlive() {
        try {
            restTemplate.headForHeaders(this.kgServiceClient.getAuthEndpoint());
            return true;
        } catch (Exception e) {
            return false;
        }
